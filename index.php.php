...
<html lang="en" class=" -webkit-">
   ...
   <body>
      ...
      <footer style="margin: 0 auto; bottom: 0; position:absolute; width: 100%">
         <p style="text-align: center; font-size: 14px; word-spacing: 2px; text-transform: capitalize; color: #fff;"> copyright &copy;2022 Developed by <span style="text-transform: uppercase; opacity: 4; font-weight: 200;">David Adindu</span></p>
      </footer>
